...
tile map, `chat` for the messages) and migrates it at boot. The API refuses to start without postgres.
...
holds the ledger, bans and antibot evidence. **The tile map and the chat in postgres are not backed up
