...
- `proto/auth/v1/auth.proto` — who a caller is (`AuthService`), and `internal.proto` beside it, what other backend modules ask it (`InternalService`, never on the public router)
