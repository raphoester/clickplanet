...
func NewChatServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ChatServiceClient {
	...
	return &chatServiceClient{
		...
		listenForEvents: connect.NewClient[v1.ListenForEventsRequest, v1.ChatEvent](
			httpClient,
			baseURL+ChatServiceListenForEventsProcedure,
...
// ListenForEvents calls chat.v1.ChatService.ListenForEvents.
func (c *chatServiceClient) ListenForEvents(ctx context.Context, req *connect.Request[v1.ListenForEventsRequest]) (*connect.ServerStreamForClient[v1.ChatEvent], error) {
...
func NewChatServiceHandler(svc ChatServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	chatServiceListenForEventsHandler := connect.NewServerStreamHandler(
		ChatServiceListenForEventsProcedure,
		svc.ListenForEvents,
		connect.WithSchema(chatServiceMethods.ByName("ListenForEvents")),
		connect.WithHandlerOptions(opts...),
	)
