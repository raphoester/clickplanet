...
func TestAPruneDeletesMessagesAndReactionsPastRetention(t *testing.T) {
	...
	deleted, err := prune_usecase.New(24*time.Hour, cptime.NewFixedClock(now), sent, given).Execute(t.Context())
