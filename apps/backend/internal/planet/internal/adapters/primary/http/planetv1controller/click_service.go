...
// five procedures. That is the whole of its job, and it has no constructor
// because there is nothing to construct: it is five handlers in a bag, and the
...
//
// The five are embedded, so every method is promoted rather than written: there
