...
func NewVPNBlockInterceptor(blocklist ClickBlocklist, registerer prometheus.Registerer) connect.Interceptor {
	blocked := promauto.With(registerer).NewCounterVec(prometheus.CounterOpts{
		Name: "blocked_clicks",
